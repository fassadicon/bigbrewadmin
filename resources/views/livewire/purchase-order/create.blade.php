        ...
        <form wire:submit="store">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg sm:rounded-lg w-full">
                <div class="flex flex-wrap p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <div>
                            @if (count($purchaseOrderItems) > 1)
                                <button wire:click='removePurchaseOrderItem({{ $key }})'
                                    type="button"
                                    class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-1 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">-
                                </button>
                            @endif
                        </div>
                        <div class="mt-20">
                    ...
                    <div>
                        <button type="submit"
                            class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Create Purchase Order</button>
                    </div>
                </div>
            </div>
        </form>
