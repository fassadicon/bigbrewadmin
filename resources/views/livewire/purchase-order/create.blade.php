<div>
    <div class="flex mx-auto px-4">
        <button x-data="" x-on:click.prevent="$dispatch('open-modal', 'create-supplier')" type="button"
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg sm:rounded-lg w-full">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="mb-6">
                        ...
                        <select wire:model.live='supplier_id' name="supplier_id" id="supplier_id">
                    ...
                    <div>
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                            ...
                            <select wire:model='purchaseOrderItems.{{ $key }}.inventory_item_id'
                                ...
                                name="inventory_item_id" id="inventory_item_id{{ $key }}">
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                            ...
                            <input wire:model.live="purchaseOrderItems.{{ $key }}.amount" id="amount_{{ $key }}"
                                type="text"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                readonly>
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                            ...
                            <input wire:model="purchaseOrderItems.{{ $key }}.description" id="description_{{ $key }}"
                                type="text"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div class="mb-6">
                            ...
                            <button wire:click='removePurchaseOrderItem({{ $key }})' type="button" class="bg-red-500">
                                Remove
                            </button>
                            @endif
                        </div>
