<div>
    <a href="{{ route('purchase-orders.create') }}"
        wire:navigate
        type="button"
        class="text-white bg-blue-800 hover:bg-blue-950 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 ml-4 mb-2 dark:bg-red-500 dark:hover:bg-red-200 focus:outline-none dark:focus:ring-blue-800">
