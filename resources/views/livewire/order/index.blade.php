        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    ...
                    <button wire:click='export' class="p-2 bg-amber-800 hover:bg-amber-950 text-white rounded ml-8 mt-8">Export</button>
                    <livewire:order.show />
                    @endif
                    {{-- Search Filters --}}
                    <div class="flex items-center justify-between d p-4">
                        <div class="flex">
                            <div class="relative w-full">
                                ...
                                <input wire:model.live.debounce.300ms='search' type="text"
                                    ...
                                    placeholder="Search order number, admin" required="">
                            </div>
                        </div>
                        ...
                        <div class="flex items-center">
                            <div class="relative">
                                ...
                                <input id="date_start" datepicker datepicker-autohide datepicker-buttons name="start"
                                    type="text"
                            ...
                            <div class="relative">
                                ...
                                <input id="date_end" datepicker datepicker-autohide datepicker-buttons name="end"
                                    type="text"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead>
                                ...
                                <th scope="col" class="px-4 py-3">Catered By</th>
