    ...
    <form wire:submit="update">
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg"
            ...
            <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                <div class="mb-6">
                    <label for="alias"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Alias<span
                            class="text-red-500"> * </span></label>
                ...
                <div class="mb-6">
                    <label for="measurement"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Measurement<span
                            class="text-red-500"> * </span></label>
