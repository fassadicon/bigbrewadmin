    <aside
        ...
        <a href="#"
            class="h-20 flex items-center px-4 bg-red-50 hover:text-gray-800 hover:bg-opacity-50 focus:outline-none focus:text-gray-100 focus:bg-opacity-50 overflow-hidden" wire:navigate>
        ...
        <nav class="p-4 space-y-2 font-medium">
            ...
            <a href="{{ route('products') }}"
                class="flex items-center h-10 px-3 hover:bg-amber-800 hover:text-amber-950 hover:bg-opacity-25 rounded-lg transition-colors duration-150 ease-in-out focus:outline-none focus:shadow-outline" wire:navigate>
            ...
            <a wire:navigate href="{{ route('sizes') }}"
                class="flex items-center h-10 px-3 hover:bg-amber-800 hover:text-amber-950 hover:bg-opacity-25 rounded-lg transition-colors duration-150 ease-in-out focus:outline-none focus:shadow-outline" wire:navigate>
        ...
        <div class="border-t border-gray-700 p-4 font-medium mt-auto">
            <a href="#"
                class="flex items-center h-10 px-3 hover:text-amber-950 hover:bg-amber-800 hover:bg-opacity-25 rounded-lg transition-colors duration-150 ease-in-out focus:outline-none focus:shadow-outline" wire:navigate>
