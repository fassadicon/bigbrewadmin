    <aside
        ...
        <nav class="p-4 space-y-2 font-medium">
            <a href="{{ route('dashboard') }}"
                class="flex items-center h-10 px-3 text-white bg-red-500 rounded-lg transition-colors duration-150 ease-in-out focus:outline-none focus:shadow-outline"
                wire:navigate>
            ...
            <a href="{{ route('orders') }}"
                class="flex items-center h-10 px-3 hover:bg-red-500 hover:bg-opacity-25 rounded-lg transition-colors duration-150 ease-in-out focus:outline-none focus:shadow-outline"
                wire:navigate>
                <svg viewBox="0 0 20 20"
                    fill="currentColor"
                    class="h-6 w-6 flex-shrink-0">
